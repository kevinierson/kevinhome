    ...
    <el-row style="height: calc(100vh - 140px);">
      ...
      <el-dialog
        ...
        <div style="margin-top: 20px">
          ...
          <ImgUpload @onUpload="uploadImg" ref="imgUpload" style="margin-top: 5px"></ImgUpload>
        </div>
...
<script>
   import ImgUpload from '../../common/admin/ImgUpload.vue'
      ...
      saveArticles (value, render) {
        ...
        this.$confirm('是否保存并发布文章?', '提示', {
          ...
          type: 'warning'
            ...
            this.$axios
              .post('http://127.0.0.1:8081/admin/content//detail', {
                id: this.article.id,
